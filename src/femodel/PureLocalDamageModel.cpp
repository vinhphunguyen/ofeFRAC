 ...
 *  
 *  This class implemens the local damage model using finite elements
 *  
...
//=======================================================================
//   class PureLocalDamageModel
//=======================================================================


class PureLocalDamageModel : public Model
{
 public:

  typedef PureLocalDamageModel  Self;
  typedef Model             Super;
...
const char*  PureLocalDamageModel::DOF_NAMES[3]     = { "dx", "dy", "dz" };

const char*  PureLocalDamageModel::SHAPE_PROP       = "shape";
const char*  PureLocalDamageModel::MATERIAL_PROP    = "material";
...
PureLocalDamageModel::PureLocalDamageModel
...
void PureLocalDamageModel::configure
...
void PureLocalDamageModel::getConfig ( const Properties& conf ) const
{
}
...
bool PureLocalDamageModel::takeAction
...
void PureLocalDamageModel::getMatrix_
...
void PureLocalDamageModel::getMatrix20_
...
void PureLocalDamageModel::getMatrix21_
...
void PureLocalDamageModel::checkCommit_
...
bool PureLocalDamageModel::getTable_
...
void PureLocalDamageModel::getStress_
...
void PureLocalDamageModel::getHistory_
...
static Ref<Model>     newPureLocalDamageModel
...
{
  return newInstance<PureLocalDamageModel> ( name, conf, props, globdat );
}
...
void declarePureLocalDamageModel ()
{
  ...
  ModelFactory::declare ( "PureLocalDamage", & newPureLocalDamageModel );
}
